...
FORMAT_INSTRUCTIONS: dict[str, str] = {
    "deep_dive": (
        ...
        "the trickiest interview angles and genuine gaps that are confirmed by the materials; "
        "never claim the candidate lacks experience that appears in the provided artifacts. "
        "Close with 2-3 concrete things to remember walking in.\n\n"
    ...
    "deep_dive_long": (
        ...
        "Be honest about gaps and unknowns rather than papering over them, but only surface "
        "gaps that are confirmed by absence from the provided materials."
    ),
    "brief": (
    ...
    "qa_drill": (
        ...
        "that probes a genuine gap or weakness verifiable from the provided materials. "
        "Each Q&A pair should feel like a mini "
    ...
    "critical_analysis": (
        ...
        "industry transitions, tenure patterns, missing keywords, overqualification). Each "
        "objection must be verifiable from the provided materials; never claim the candidate "
        "lacks experience that appears in the MASTER RESUME, TAILORED RESUME, or BRIEFING. For "
